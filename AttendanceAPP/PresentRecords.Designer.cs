namespace AttendanceAPP
{
    partial class PresentRecords
    {
        ...
        private void InitializeComponent()
        {
            ...
            label8 = new Label();
            TotalDaysAbsent = new TextBox();
            label7 = new Label();
            label6 = new Label();
            label5 = new Label();
            label4 = new Label();
            label3 = new Label();
            TotalDaysPresent = new TextBox();
            ...
            // TotalDaysAbsent
            // 
            TotalDaysAbsent.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
            TotalDaysAbsent.Location = new Point(930, 551);
            TotalDaysAbsent.Name = "TotalDaysAbsent";
            TotalDaysAbsent.ReadOnly = true;
            TotalDaysAbsent.Size = new Size(236, 27);
            TotalDaysAbsent.TabIndex = 38;
            // 
            // label7
            // 
            ...
            label6.Location = new Point(716, 448);
            label6.Name = "label6";
            ...
            // TotalDaysPresent
            // 
            TotalDaysPresent.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
            TotalDaysPresent.Location = new Point(930, 518);
            TotalDaysPresent.Name = "TotalDaysPresent";
            TotalDaysPresent.ReadOnly = true;
            TotalDaysPresent.Size = new Size(236, 27);
            TotalDaysPresent.TabIndex = 32;
            // 
            // txtUsername
            // 
            txtUsername.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
            txtUsername.Font = new Font("Lucida Fax", 10.2F, FontStyle.Bold);
            txtUsername.Location = new Point(930, 448);
            ...
            Exportbtn.Location = new Point(1177, 15);
            ...
            ExpUser.Location = new Point(361, 481);
            ...
            userCheckbox.Location = new Point(283, 482);
            userCheckbox.Name = "userCheckbox";
            userCheckbox.Size = new Size(90, 27);
            userCheckbox.TabIndex = 47;
            ...
            label9.Font = new Font("Lucida Fax", 11F, FontStyle.Bold);
            label9.Location = new Point(714, 484);
            label9.Name = "label9";
            label9.Size = new Size(212, 22);
            label9.TabIndex = 50;
            label9.Text = "Total Working Days:";
            // 
            // TotalWorkingDays
            // 
            TotalWorkingDays.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
            TotalWorkingDays.Location = new Point(930, 482);
            TotalWorkingDays.Name = "TotalWorkingDays";
            TotalWorkingDays.ReadOnly = true;
            TotalWorkingDays.Size = new Size(236, 27);
            TotalWorkingDays.TabIndex = 49;
            // 
            // PresentRecords
            // 
            ...
            Controls.Add(label9);
            Controls.Add(TotalWorkingDays);
            Controls.Add(ExpUser);
            Controls.Add(userCheckbox);
            Controls.Add(dataGridView);
            Controls.Add(pictureBoxImage);
            Controls.Add(label8);
            Controls.Add(TotalDaysAbsent);
            Controls.Add(label7);
            Controls.Add(label6);
            Controls.Add(label5);
            Controls.Add(label4);
            Controls.Add(label3);
            Controls.Add(TotalDaysPresent);
        ...
        private TextBox TotalDaysAbsent;
        private Label label7;
        private Label label6;
        private Label label5;
        private Label label4;
        private Label label3;
        private TextBox TotalDaysPresent;
        ...
        private TextBox TotalWorkingDays;
    }
}